...
Page({
  ...
  freeCollect: function(e) {
    ...
    if (userInfo.nickName == null || userInfo.nickName == '') {
      ...
      var pageUrl = encodeURIComponent('pages/staff/activity/showList/index?staffId=' + staffId)
      var userInfo = wx.getStorageSync('userInfo');
  ...
  activityDetail: function(e) {
    ...
    if (isGet > 0) {
      wx.navigateTo({
        url: '../../../../pages/action/list/detail/index?activityId=' + activityId + '&holderId=' + holderId + '&staffId=' + staffId,
      })
    } else {
      wx.navigateTo({
        url: '../../../../pages/staff/activity/getDetail/index?activityId=' + activityId + '&staffId=' + staffId,
      })
    }

var NewApiRootUrl = 'https://wxprograme.wemeke.com/stock/';
...
module.exports = {
  ...
  myShareUrl: NewApiRootUrl + '/api/shareholderMessage/getApiMyBonusDetail',//我的分红
  myShareDetail: NewApiRootUrl + '/api/accountBonusRecord/getApiBonusPageList',//我的分红明细 
  myHolderDetail: NewApiRootUrl + '/api/accountShareholderRecord/getApiAccountShareholderRecordPageList',//我的股金明细 
  mySourceList: NewApiRootUrl + '/api/ShareholderRelation/getApiRelationPageList',//我的客源
  mySourceDetail: NewApiRootUrl + '/api/ShareholderRelation/getApiMyRelationDetail',//我的客源详情
  holderActivity: NewApiRootUrl + '/api/saleActivity/checkSaleActivity.json',//验证是否有消息活动列表
  actionListUrl: NewApiRootUrl + '/api/saleActivity/list.json',//拓客活动列表
  actionDetailUrl: NewApiRootUrl + '/api/saleActivity/detail.json',//拓客活动详情
  actionGetlUrl: NewApiRootUrl + '/api/saleActivity/get.json',//领取活动
  actionCodelUrl: NewApiRootUrl + '/api/saleActivity/getCheckCode.json',//使用核销码
  actionPaylUrl: NewApiRootUrl + '/api/saleActivity/checkList.json',//核销列表
  actionMessagelUrl: NewApiRootUrl + '/api/saleActivity/message.json',//消息列表
  // shareAction: NewApiRootUrl + 'apiUrl/' + tenantId + '/activity/',//消息列表
  getwxacode: NewApiRootUrl + '/api/common/getwxacode', //菊花码
  actionPage: NewApiRootUrl + '/api/home/getHomeImage', //首页封面图  
  actionStoreList: NewApiRootUrl + '/api/store/getOrgListShareHolder.json', //清量版租户门店列表 
  actionStoreDetail: NewApiRootUrl + '/api/store/detailShareHolder.json', // 清量版租户门店详情
  tenantList: NewApiRootUrl + '/api/my/tenantList', //租户列表
  checkShareHolder: NewApiRootUrl + '/api/my/checkShareHolder', //选择租户股东详情
  tenantMore: NewApiRootUrl + '/api/common/synchronizationMessage', //多个租户

  superStaffDetail: NewApiRootUrl + '/api/my/getSuperStaffMessage.json',//超级员工基本详情
  superStaffList: NewApiRootUrl + '/api/staffActivity/staffActivityList.json',//超级员工活动列表
  superStaffGet: NewApiRootUrl + '/api/staffActivity/get.json',//超级员工领取活动
  superStaffActivityDetail: NewApiRootUrl + '/api/staffActivity/staffActivityDetail.json',//超级员工活动详情
  superStaffBind: NewApiRootUrl + '/api/staffActivity/bindStaff.json',//超级员工绑定
  superStaffState: NewApiRootUrl + '/api/staffActivity/changeState.json',//超级员工活动是否展示

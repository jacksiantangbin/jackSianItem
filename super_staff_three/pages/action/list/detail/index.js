...
Page({
    ...
    util.request(api.actionDetailUrl, data).then(function(res) {
      if (res.errno == 0) {
        ...
        that.setData({
          ...
          beginDate: beginDate,
          endDate: endDate,
          laterDays: res.data.saleActivity.laterDays,
          validateType: res.data.saleActivity.validateType,
        });
  ...
  sharePage: function (e) {
    ...
    if (validateType > 1){
      ...
      var laterDays = this.data.laterDays
    }
    ...
    var that = this
    wx.navigateTo({
      url: '../../../../pages/share/shareCode2/index?groupTitle=' + groupTitle + '&groupImg=' + groupImg + '&groupPrice=' + groupPrice + '&groupDetailUrl=' + groupDetailUrl_last + '&scene=' + scene + '&pageIndex=' + pageIndex + '&beginDate=' + beginDate + '&endDate=' + endDate + '&laterDays=' + laterDays + '&validateType=' + validateType,
    })
  },
  /**,
   * 生命周期函数--监听页面初次渲染完成

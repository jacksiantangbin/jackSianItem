<template>
  <el-dialog :title="!dataForm.orderNumber ? '新增' : '修改'"
            ...
            <div class="num-cont">
              ...
              <el-form-item>
                <el-steps :active="stepsStatus"
                  ...
                  <el-step title="提交订单"
                           :description="dataForm.orderTime"></el-step>
                  <el-step title="买家已付款"
                           :description="dataForm.payTime"></el-step>
                  <el-step title="卖家已发货"
                           :description="dataForm.dvyTime"></el-step>
                  <el-step title="买家已收货"
                           :description="dataForm.finallyTime"></el-step>
                </el-steps>
              </el-form-item>
            </div>
          </div>
              ...
              <div class="state-title">
                <el-form-item label="订单状态:">
                  <template slot-scope="scope">
                    ...
                    <el-tag v-if="dataForm.status === 2"
                            size="small"
                            type="warning">待发货</el-tag>
                    <el-tag v-if="dataForm.status === 3"
                            size="small"
                            type="warning">待收货</el-tag>
                    <el-tag v-if="dataForm.status === 4"
                            size="small"
                            type="warning">待评价</el-tag>
                    <el-tag v-if="dataForm.status === 5"
                            size="small"
                            type="success">成功</el-tag>
                    <el-tag v-if="dataForm.status === 6"
                            size="small"
                            type="danger">失败</el-tag>
                    <el-tag v-if="dataForm.status === 7"
                            size="small"
                            type="danger">待成团</el-tag>
                  </template>
                </el-form-item>
                <el-form-item>
                  <el-row>
                    <el-button type="primary"
                               ...
                               plain
                               @click="changeOrder(dataForm.orderNumber)">发货</el-button>
    ...
    <!-- 弹窗, 新增 / 修改 -->
    <devy-add v-if="devyVisible"
              ref="devyAdd"
              @refreshDataList="getDataList"></devy-add>
  </el-dialog>
</template>

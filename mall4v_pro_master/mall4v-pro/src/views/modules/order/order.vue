              ...
              <el-col :span="3"
                ...
                <div class="item">
                  <div>
                    ...
                    <span v-if="order.payType === 0">手动代付</span>
              ...
              <el-col :span="3"
                ...
                <div class="item">
                  ...
                  <span v-else>
                    ...
                    <span v-else-if="order.status === 7"
                          size="small"
                          type="danger">待成团</span>
              ...
              <el-col :span="3"
                ...
                <div class="item">
                  <div class="operate">
                    ...
                    <el-button v-if="isAuth('order:order:update') && order.refundStatus !== 1"
                               type="text"
                               size="small"
                               @click="addOrUpdateHandle(order.orderNumber)">修改</el-button>
                    <el-button v-if="isAuth('order:order:update') && order.refundStatus !== null"
                               type="text"
                               size="small"
                               @click="refundRoute(order.orderNumber)">退款信息</el-button>
                  </div>
                </div>
              </el-col>
            </el-row>

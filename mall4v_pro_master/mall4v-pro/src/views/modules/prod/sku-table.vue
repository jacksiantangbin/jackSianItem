  ...
  <div class="mod-prod-sku-table">
    <el-form-item>
      <el-table :data="value"
        ...
        <el-table-column v-for="(leftTitle, index) in tableLeftTitles"
                         :key="index"
                         :label="leftTitle">
        ...
        <el-table-column prop="prodName"
          ...
          <template slot-scope="scope">
            <el-input v-model="scope.row.prodName"
                      type="textarea"
                      :disabled="!scope.row.status"></el-input>
          </template>
        </el-table-column>
        ...
        <el-table-column prop="oriPrice"
                         label="市场价">
          <template slot-scope="scope">
            <el-input v-model="scope.row.oriPrice"
                      type="number"
                      :disabled="!scope.row.status"></el-input>
          </template>
        </el-table-column>
        <el-table-column prop="stocks"
                         label="库存">
          <template slot-scope="scope">
            <el-input v-model="scope.row.stocks"
                      type="number"
                      :disabled="!scope.row.status"></el-input>
          </template>
        </el-table-column>

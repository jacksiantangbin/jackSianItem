  ...
  <div class="mod-hotSearch-add-or-update">
    <el-dialog title="'审核'"
      ...
      <el-form :model="dataForm"
        ...
        <el-form-item label="银行卡号" prop="bankCard" v-if="wemekeTenantIdentity.bankCard">
          <el-input v-model="wemekeTenantIdentity.bankCard"
                    placeholder="银行卡号"
                    :disabled="dataForm.withdrawCashId !== 0" class="groupActivity-input"></el-input>
        </el-form-item>

        <el-form-item label="姓名" prop="name" v-if="wemekeTenant.name">
          <el-input v-model="wemekeTenant.name"
                    placeholder="姓名"
                    :disabled="dataForm.withdrawCashId !== 0" class="groupActivity-input"></el-input>
        </el-form-item>

        <el-form-item label="开户银行" prop="bankName" v-if="wemekeTenantIdentity.bankName">
        ...
        <el-form-item label="身份证号(法人／老板)" prop="userNum" v-if="dataForm.cardNumber">
          <el-input v-model="dataForm.cardNumber"
                    placeholder="身份证号"
                    :disabled="dataForm.withdrawCashId !== 0" class="groupActivity-input"></el-input>
        </el-form-item>

        <el-form-item label="身份证正反面(法人／老板)" v-if="wemekeTenantIdentity.frontImage">
          <pic-upload prop="identityCardPicFront"
                      v-model="wemekeTenantIdentity.frontImage"></pic-upload>
          <pic-upload prop="identityCardPicFront"
                      v-model="wemekeTenantIdentity.backImage"></pic-upload>
        </el-form-item>
        ...
        methods: {
            ...
            getDataList () {
                ...
                this.$http({
                    ...
                    this.dataForm = data
                    this.wemekeTenant = data.wemekeTenant
                    this.wemekeTenantIdentity = data.wemekeTenantIdentity
                })
            },
            // 表单提交
            dataFormSubmit () {
                this.$refs['dataForm'].validate((valid) => {
                    if (valid) {
                        ...
                        this.$http({
                            url: this.$http.adornUrl(`/distribution/wemekeTenantWithdrawCash/updateState`),
                            method:'put',
